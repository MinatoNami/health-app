...
> **Historical.** This is the design document written *before* the system was
> built, kept because the reasoning in it still explains several choices that
> would otherwise look arbitrary. It is not a description of what exists —
> [ARCHITECTURE.md](ARCHITECTURE.md) is.
>
> Where the two disagree, the code is right and this is old.
